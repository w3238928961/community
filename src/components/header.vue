			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/Friendslink"><i class="fa fa-wa fa-users"></i>留言板</el-menu-item>

              <el-menu-item>
                <el-input v-model="keyword" placeholder="请输入关键词" ></el-input>
                <el-button icon="el-icon-search" @click="search(keyword)"
                           style="background-color:#00BFFF;border-color: #00BFFF; font-size: 14px;color: #fff;text-align: center;"
                >搜索</el-button>
              </el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"向海风许愿，在山海相见"}}
...
export default {
  ...
  //
  //   search(keyword) {
  //     // 在这里写搜索的代码，可以根据需要调用您编写的脚本。
  //     // 下面是一个示例代码，在控制台输出搜索关键字：
